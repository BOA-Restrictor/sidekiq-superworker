  ...
  describe '#rewrite_record_ids' do
    context 'hash with children' do
      it 'rewrites the record ids' do
        ...
        dsl_hash = described_class.new(hash)
      ...
      it 'returns the correct records' do
        ...
        dsl_hash.to_records.should ==
          { 1 =>
            { subjob_id: 1,
              subworker_class: 'batch',
              arg_keys:               [{ first_arguments: :first_argument, second_arguments: :second_argument }],
              arg_values:               [{ first_arguments: :first_argument, second_arguments: :second_argument }],
              parent_id: nil,
              children_ids: [2, 5, 8] },
            2 =>
            { subjob_id: 2,
              subworker_class: 'batch_child',
              arg_keys: %i[first_argument second_argument],
              arg_values: [10, 20],
              parent_id: 1,
              children_ids: [3, 4] },
            3 =>
